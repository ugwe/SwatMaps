/*modified leaflet slide menu plugin js file for SwatMaps*/
L.Control.SlideMenu = L.Control.extend({
    options: {
        direction: 'horizontal', 
        changeperc: '10', 
        icon_open: 'fa-solid fa-image fa-flip fa-xl',
        icon_close: {
            class_up: 'fa fa-window-close',
            class_down: 'fa fa-window-close',
            class_left: 'fa fa-window-close',
            class_right: 'fa fa-window-close',
            size: '16pt',
            color: '#9a2a2a',
        }
    },
    ...
    onAdd: function(map){
        ...
        link.title = 'Menu';
        L.DomUtil.create('span', this.options.icon_open, link);
